...
if(array_key_exists('register', $_POST)){
  ...
  if(empty($_POST['hash'])){
    $error['hash']="enter confirm password";
  }

  if($_POST['hash']!=$_POST['password']){
    $error['hash']="Password mismatch";
  }
 		...
 		<div class="container">
 			...
 			<div class="login-form-grids">
 				...
 				<h6>Login information</h6>
 					...
 					<input type="password" placeholder="Password Confirmation" required=" " name="hash" >
 					<div class="register-check-box">
 						<div class="check">
